...
double CTransform3x3::Determinant()
{
	return 
		  m_array[0][0] * (m_array[1][1]*m_array[2][2] - m_array[1][2]*m_array[2][1])
		- m_array[0][1] * (m_array[1][0]*m_array[2][2] - m_array[1][2]*m_array[2][0])
		+ m_array[0][2] * (m_array[1][0]*m_array[2][1] - m_array[1][1]*m_array[2][0]);
}
